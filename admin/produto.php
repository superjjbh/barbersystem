        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-tags"></i> <span>Produtos Cadastrados</span></h2>
                ...
                <!--/ End page header -->
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-left">
								<a href="produto/novo/"><button type="button" class="btn btn-success"><i class="fa fa-plus-circle"></i> Novo Produto</button></a>
                            </div>
                ...
                <div class="body-content animated fadeIn">
                    <ul class="col-md-12 row">
                        <?php if (isset($produtos->db->data[0])): ?>
                            <?php foreach ($produtos->db->data as $listar): ?>
                                <div class="col-md-3">
                                    <div class="gallery-item rounded shadow">
                                        <span class="gallery-love">
                                            <i class="fa fa-heart-o"></i>
                                        </span>
                                        <a href="javascript:void(0);" style="cursor:default" class="gallery-img"><img src="thumb.php?w=400&h=300&zc=1&src=../images/team/<?= $listar->produto_imagem ?>" class="img-responsive full-width" alt="..." /></a>
                                        <br />
                                        <div class="gallery-author">
                                            <div class="media">
                                                <div class="media-body text-center">
                                                    <h3 class="media-heading text-capitalize"> <?= stripslashes($listar->produto_nome) ?> </h3>
													</br>
													<h4 class="media-heading text-capitalize">R$ <?= stripslashes($listar->produto_preco) ?> </h4>
													<h4 class="media-heading text-capitalize">Categoria: <?= stripslashes($listar->produto_categoria) ?> </h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="gallery-details">
                                            <div class="text-center">
                                                <a class="btn btn-circle btn-info atualizar"  href="produto/editar/<?= $listar->produto_id ?>/">
                                                    <i class="fa fa-edit icon-white"></i>
                                                </a>
                                                <a class="btn btn-circle btn-danger delete" data-url="produto_fn.php?acao=remover&AMP;id=<?= $listar->produto_id ?>">
