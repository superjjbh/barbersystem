        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-tags"></i>  <span>Promoção</span></h2>
                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info" style="padding-top: 19px;"><p><strong>Cadastrar Promoção</strong></p></div>
                                </div>
                                ...
                                <div class="panel-body no-padding">
                                    <form enctype="multipart/form-data" method="post" action="cliente_fn.php?acao=incluir">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Descrição Rápida</label>
                                                <input class="form-control rounded" type="text" id="cliente_subtitulo"  name="cliente_subtitulo" />
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label">Valor (Sem o R$, apenas o valor)</label>
                                                <input class="form-control rounded" type="text" id="cliente_descricao"  name="cliente_descricao" value="<?= stripslashes($cliente->cliente_descricao) ?>" />
                                            </div>
