                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info" style="padding-top: 19px;"><p><strong>Editar Galeria de Fotos</strong></p></div>
                                ...
                                <div class="panel-body no-padding">
                                    <form  enctype="multipart/form-data" method="post" action="portfolio_fn.php?acao=atualizar">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Título da Galeria ou Foto</label>
