                            ...
                            <div class="panel rounded shadow">
                                ...
                                <div class="panel-body no-padding">
                                    ...
                                    <form method="post" action="contato_fn.php?acao=atualizar">
                                        <div class="form-body">
                                            <div class="form-group">                                                <span class="pull-right"><i class="fa fa-exclamation-triangle"></i> Informe o nome da Unidade, pode ser o Bairro, por exemplo.</span>                                                <label class="control-label"> Nome da Unidade</label>                                                <input type="text" class="form-control rounded" id="contato_telefone6" name="contato_telefone6"  value="<?= $contato->contato_telefone6 ?>" />                                            </div>
                                            ...
                                            <div class="form-group">
                                                <span class="pull-right"><i class="fa fa-exclamation-triangle"></i> Telefone Celular</span>
                                            ...
                                            <div class="form-group">
                                                <span class="pull-right"><i class="fa fa-exclamation-triangle"></i> Preencha dessa forma: DDDNÚMERO. Exemplo: 31986407398</span>
                                            ...
                                            <div class="form-group">                                                <span class="pull-right"><i class="fa fa-exclamation-triangle"></i> Informe a Latitude e Longitude para o Mapa. Saiba qual sua latitude e longitude através desse link <a href="https://www.mapsdirections.info/pt/coordenadas-gps.html" target="_blank">CLIQUE AQUI</a></span>                                                <label class="control-label"> Latitude</label>                                                <input type="text" class="form-control rounded" id="contato_telefone4" name="contato_telefone4" value="<?= $contato->contato_telefone4 ?>" />                                                </br>												<label class="control-label"> Longitude</label>                                                <input type="text" class="form-control rounded" id="contato_telefone5" name="contato_telefone5" value="<?= $contato->contato_telefone5 ?>" />                                            </div>
                                            <div class="form-group">
