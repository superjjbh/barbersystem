        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-photo"></i> Galeria de Fotos<span></span></h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info" style="padding-top: 19px;"><p><strong>Editar Galeria</strong></p></div>
                                </div><!-- /.panel-subheading -->
                            <div class="pull-right">
                                <a href="galeria/"><button class="btn btn-warning">Cancelar</button></a>
                            </div>
                                ...
                                <div class="panel-body no-padding">
                                    <form  enctype="multipart/form-data" method="post" action="portfolio_fn.php?acao=atualizar">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Título da Foto</label>
                                            ...
                                            <!--<div class="form-group">
                                                <span class="pull-right"><i class="fa fa-exclamation-triangle"></i> Caso não seja fotos de clientes, deixe esse campo vazio!</span>
                                                <label class="control-label">Cliente (Caso queira informar o nome do cliente)</label>
                                                <input class="form-control" type="text" id="portfolio_cliente"  name="portfolio_cliente" value="<?= stripslashes($work->portfolio_cliente) ?>" />
                                            </div>
											
                                            <div class="form-group">
                                                <span class="pull-right"><i class="fa fa-exclamation-triangle"></i> Caso não tenha nenhum vídeo, deixe esse campo vazio!</span>
                                                <label class="control-label">Vídeo (Código final do vídeo. Exemplo: https://youtu.be/<b>xUMeyysrgdo</b>)</label>
                                                <input class="form-control" type="text" id="portfolio_url"  name="portfolio_url" value="<?= stripslashes($work->portfolio_url) ?>" />
                                            </div>-->
                                            ...
                                            <div class="form-group">
												...
												<input type="hidden" id="portfolio_descricao" name="portfolio_descricao" value="<?= stripslashes($work->portfolio_descricao) ?>" >
                                            </div><!-- /.form-group -->
