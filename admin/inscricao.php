                ...
                <div class="body-content animated fadeIn">
                    <div class="row">
                        <div class="col-md-12">
							...
							<h3 class="panel-title"><a class="btn btn-success" href="gerarInscricoes.php"  style="color:#fff"><i class="fa fa-file-excel-o" ></i> Exportar Inscrições para Excel</a></h3>										
