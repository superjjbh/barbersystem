                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info" style="padding-top: 19px;"><p><strong>Cadastrar Curso</strong></p></div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="panel-body no-padding">
                                    <form enctype="multipart/form-data" method="post" action="curso_fn.php?acao=incluir">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
												...
												<h4><input type="radio" id="curso_status" name="curso_status" value="SIM" checked> SIM</h4>
												<h4><input type="radio" id="curso_status" name="curso_status" value="NAO" > NÃO </h4>
                                            </div>
