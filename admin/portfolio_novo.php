                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info" style="padding-top: 19px;"><p><strong>Cadastrar Galeria</strong></p></div>									
                                </div>
                                ...
                                <div class="panel-body no-padding">
                                    <form enctype="multipart/form-data" method="post" action="portfolio_fn.php?acao=incluir">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
												<input type="hidden" id="portfolio_descricao" name="portfolio_descricao" value="Foto" >
                                            </div>
