...
$result0 = mysqli_query($conn, "SELECT count(servico_id) AS contagem FROM servico where servico_status = 0 AND servico_data = '$datacorrente'");
$resultsoma0 = mysqli_query($conn, "SELECT sum(servico_valor_total) AS valor FROM servico where servico_status = 0 AND servico_data = '$datacorrente'");
...
$result1 = mysqli_query($conn, "SELECT count(servico_id) AS contagem FROM servico where servico_status IN (1,3) AND servico_data = '$datacorrente'");
$resultsoma1 = mysqli_query($conn, "SELECT sum(servico_valor_total) AS valor FROM servico where servico_status IN (1,3) AND servico_data = '$datacorrente'");
...
$result2 = mysqli_query($conn, "SELECT count(servico_id) AS contagem FROM servico where servico_status = 2 AND servico_data = '$datacorrente'");
$resultsoma2 = mysqli_query($conn, "SELECT sum(servico_valor_total) AS valor FROM servico where servico_status = 2 AND servico_data = '$datacorrente'");
        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                <div class="header-content">
                    <h2><i class="fa fa-calendar-o"></i> Agenda de Hoje</h2>
...
<div class="panel-group" id="accordion">
		<?php $servico->getServicosNaoConfHoje(); ?>
...
<div class="panel-group" id="accordion">
		<?php $servico->getServicosConfHoje(); ?>
            <?php if (isset($servico->db->data[0])): ?>
                <?php foreach ($servico->db->data as $service): ?>
							<div class="panel panel-default">
								<div class="panel-heading">
...
<h3><font style="color:#009900;font-weight:bold;">Atendidos: </font><?= stripslashes($atendido) ?></h3>
	<h4>Valores Recebidos: R$ </font><?= stripslashes($valoratendido) ?></h4>
<div class="panel-group" id="accordion">
		<?php $servico->getServicosAtendHoje(); ?>
            <?php if (isset($servico->db->data[0])): ?>
                <?php foreach ($servico->db->data as $service): ?>
							<div class="panel panel-default">
								<div class="panel-heading">
