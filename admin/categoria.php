        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i> <span>Gerenciar Categorias de Produtos</span></h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title"><button class="btn btn-success" data-toggle="modal" data-target="#incluir"><i class="fa fa-plus-circle"></i> Nova Categoria</button></h3>
                                    </div>
                                        ...
                                        <tbody id="galeria">
                                            <?php if (isset($categoria->db->data[0])): ?>
                                                <?php foreach ($categoria->db->data as $categorias): ?>
                                                    <tr id="li_<?= $categorias->categoria_id ?>">
                                                        <td><?= stripslashes($categorias->categoria_nome) ?></td>
                                                        <td style="width: 20%;">
                                                            <a class="btn btn-circle btn-info atualizar" data-update="<?= $categorias->categoria_id ?>" >
                                                                <i class="fa fa-edit icon-white"></i>
                                                            </a>
                                                            <a class="btn btn-circle btn-danger delete" data-url="categoria_fn.php?acao=remover&AMP;id=<?= $categorias->categoria_id ?>">
            ...
            <div class="modal-dialog panel panel-primary">
                <div class="modal-content ">
                    ...
                    <div class="modal-header ">
                        <form role="form" method="post"  action="categoria_fn.php?acao=incluir">
                            <div class="form-group">
                                <label for="categoria_nome">Categoria:</label>
                                <input type="text" class="form-control"  name="categoria_nome" data-toggle="tooltip" data-placement="bottom" title="Informe a Categoria..."  required />
                            </div>
        ...
        <div class="modal fade" id="modal-16" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog panel panel-primary">
                <div class="modal-content ">
                    ...
                    <div class="modal-header ">
                        <form role="form" method="post"  action="categoria_fn.php?acao=atualizar">
                            <div class="form-group">
                                <label for="categoria_nome">Categoria:</label>
                                <input type="text" class="form-control"  name="categoria_nome" id="categoria_nome" data-toggle="tooltip" data-placement="bottom" title="Informe a Categoria..." value="<?= stripslashes($categoria->categoria_nome) ?>" required />
                                <input type="hidden" id="categoria_id"  name="categoria_id" value="<?= $categoria->categoria_id ?>">
                            </div>
...
<?php endif; ?>
            ...
            $('.atualizar').on('click', function () {
                ...
                $('#categoria_id').val(id);
                var url = "categoria_fn.php?acao=Json";
                $.getJSON(url, {categoria_id: id}, function (data) {
                    //console.log(data);
                    $('#modal-16  #categoria_id').val(data.categoria_id);
                    $('#modal-16  #categoria_nome').val(data.categoria_nome);
                });
                $('#modal-16').modal('show');
            });
            ...
            function reloadActions() {
                ...
                $("#galeria").sortable({opacity: 0.6, cursor: "move",
                    stop: function (event, ui) {
                        ...
                        var url = 'categoria_fn.php?acao=posicao';
