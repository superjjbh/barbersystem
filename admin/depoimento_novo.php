                                ...
                                <div class="panel-body no-padding">
                                    <form enctype="multipart/form-data" method="post" action="depoimento_fn.php?acao=incluir">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <span class="pull-right"><i class="fa fa-exclamation-triangle"></i> Atenção: Máximo de 200 caracteres. </span>
											...
											<h4 class="media-heading text-capitalize"> Publicado: </h4>
												<h4><input type="radio" id="depoimento_cargo" name="depoimento_cargo" style="text-transform: uppercase;" value="SIM" required> Sim </h4>
												<h4><input type="radio" id="depoimento_cargo" name="depoimento_cargo" style="text-transform: uppercase;" value="NÃO" > Não </h4>											  
											</div>
