        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-cut"></i> <span>Gerenciar Serviços </span></h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title"><a href="servico/novo/"><button class="btn btn-primary" ><i class="fa fa-plus-circle"></i> Novo Serviço</button></a></h3>
                                    </div>
                                    <div class="pull-right">
                                        <h3 class="panel-title"><a href="categoria/servico/"><button class="btn btn-warning" ><i class="fa fa-code-fork"></i> Categorias</button></a></h3>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="datatable-ajax" class="table table-striped table-primary">
                                        <thead>
                                            <tr>
                                                <th data-class="expand">Serviços</th>
                                        ...
                                        <tbody id="galeria">
                                            <?php if (isset($pagina->db->data[0])): ?>
                                                <?php foreach ($pagina->db->data as $listar): ?>
                                                    <tr id="li_<?= $listar->pagina_id ?>">
                                                        <td><?= stripslashes($listar->pagina_nome) ?></td>
                                                        <td><?= stripslashes($listar->area_nome) ?></td>
                                                        <td style="width: 30%;">
															<a class="btn btn-circle btn-info atualizar" href="servico/editar/<?= $listar->pagina_id ?>/">
