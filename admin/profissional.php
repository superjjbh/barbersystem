...
$profissional->db->url = "profissional";
$profissional->db->paginate(24);
        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-trophy"></i> Profissionais </h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title"><button class="btn btn-primary" data-toggle="modal" data-target="#incluir"><i class="fa fa-plus-circle"></i> Novo Profissional</button></h3>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="datatable-ajax" class="table table-striped table-primary">
                                        <thead>
                                            <tr>
                                                <th data-class="expand">Profissionais</th>
                                        ...
                                        <tbody id="galeria">
                                            <?php if (isset($profissional->db->data[0])): ?>
                                                <?php foreach ($profissional->db->data as $categoria): ?>
                                                    <tr id="li_<?= $categoria->profissional_id ?>">
                                                        <td><?= stripslashes($categoria->profissional_nome) ?></td>
                                                        <td style="width: 20%;">
                                                            <a class="btn btn-circle btn-info atualizar" data-update="<?= $categoria->profissional_id ?>" >
                                                                <i class="fa fa-edit icon-white"></i>
                                                            </a>
                                                            <a class="btn btn-circle btn-danger delete" data-url="profissional_fn.php?acao=remover&AMP;id=<?= $categoria->profissional_id ?>">
            ...
            <div class="modal-dialog panel panel-primary">
                <div class="modal-content ">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title text-center">Adicionar novo Profissional</h3>
                    </div>
                    <div class="modal-header ">
                        <form role="form" method="post"  action="profissional_fn.php?acao=incluir">
                            <div class="form-group">
                                <span class="fa fa-exclamation-triangle pull-right"> Informe o nome do Profissional</span>
                                <label for="profissional_nome">Profissional:</label>
                                <input type="text" class="form-control"  name="profissional_nome" data-toggle="tooltip" data-placement="bottom" title="Informe o Profissional..."  required />
                            </div>
        ...
        <div class="modal fade" id="modal-16" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog panel panel-primary">
                <div class="modal-content ">
                    <div class="panel-heading">
                        <button type="button" class="close" data-dismiss="modal">×</button>
                        <h3 class="panel-title text-center">Editar Profissional</h3>
                    </div>
                    <div class="modal-header ">
                        <form role="form" method="post"  action="profissional_fn.php?acao=atualizar">
                            <div class="form-group">
                                <span class="fa fa-exclamation-triangle pull-right"> Informe o nome do Profissional</span>
                                <label for="profissional_nome">Profissional:</label>
                                <input type="text" class="form-control"  name="profissional_nome" id="profissional_nome" data-toggle="tooltip" data-placement="bottom" title="Informe o Profissional..." value="<?= stripslashes($profissional->profissional_nome) ?>" required />
                                <input type="hidden" id="profissional_id"  name="profissional_id" value="<?= $profissional->profissional_id ?>">
                            </div>
...
<?php endif; ?>
            ...
            $('.atualizar').on('click', function () {
                ...
                var url = "profissional_fn.php?acao=Json";
                $.getJSON(url, {profissional_id: id}, function (data) {
                    //console.log(data);
                    $('#modal-16  #profissional_id').val(data.profissional_id);
                    $('#modal-16  #profissional_nome').val(data.profissional_nome);
                });
                $('#modal-16').modal('show');
            });
            ...
            function reloadActions() {
                ...
                $("#galeria").sortable({opacity: 0.6, cursor: "move",
                    stop: function (event, ui) {
                        ...
                        var url = 'profissional_fn.php?acao=posicao';
