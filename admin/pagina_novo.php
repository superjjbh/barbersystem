                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info"  style="padding-top: 19px;"><p><strong>Cadastrar Serviço</strong></p></div>
                                </div>
                                    ...
                                    <form enctype="multipart/form-data" method="post" action="pagina_fn.php?acao=incluir">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
												...
												<h4><input type="radio" id="pagina_data" name="pagina_data" style="text-transform: uppercase;" value="SIM" required > SIM </h4>
												<h4><input type="radio" id="pagina_data" name="pagina_data" style="text-transform: uppercase;" value="NÃO" > NÃO </h4>											  
                                            </div>
