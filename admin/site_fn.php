...
function atualizar() {
    ...
    $update->site_sobre_titulo = addslashes($_POST['site_sobre_titulo']);
    $update->site_sobre = addslashes($_POST['site_sobre']);
    ...
    $update->site_imagem = addslashes($_POST['site_imagem']);
    $update->site_logo = addslashes($_POST['site_logo']);
