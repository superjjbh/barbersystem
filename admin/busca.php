        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-file-text"></i> <span>Convites Cadastrados</span></h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="pull-right">
								<a href="convite/"><button type="button" class="btn btn-warning btn-lg">Listar Todos os Convites</button></a> <a href="convite/novo/"><button type="button" class="btn btn-success btn-lg">+ Novo Convite</button></a>
                            </div>
                                        ...
                                        <div class="gallery-author">
                                            <div class="media">
                                                <div class="media-body text-center">
                                                    ...
                                                    <h4 class="media-heading text-capitalize">Ref: <?= stripslashes($listar->portfolio_cliente) ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="gallery-details">
                                            <div class="text-center">
                                                <a class="btn btn-circle btn-info atualizar"  href="convite/editar/<?= $listar->portfolio_id ?>/">
