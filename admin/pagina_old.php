        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i> <span>Serviços cadastrados</span></h2>
                ...
                <div class="body-content animated fadeIn">
							...
							<a href="servico/"><button type="button" class="btn btn-warning btn-lg">Listar todos os Serviços</button></a>
							<a href="servico/novo/"><button type="button" class="btn btn-success btn-lg">+ Novo Serviço</button></a>
							<a href="categoria/servico/"><button type="button" class="btn btn-primary btn-lg">Categorias</button></a>
                            ...
                            <?php foreach ($pagina->db->data as $listar): ?>
                                <div class="col-md-3">
                                    <div class="gallery-item rounded shadow">
                                        ...
                                        <a href="javascript:void(0);" style="cursor:default" class="gallery-img"><img src="thumb.php?w=600&h=400&zc=0&src=../images/blog/<?= $listar->pagina_imagem ?>" class="img-responsive full-width" alt="..." /></a>
                                        <br />
                                        <div class="gallery-author">
                                            <div class="media">
                                                <div class="media-body text-center">
                                                    <h4 class="media-heading text-capitalize"> <strong><?= stripslashes($listar->pagina_nome)?></strong> </h4>
                                                    <h4 class="media-heading text-capitalize">Em <?= stripslashes($listar->area_nome)?></h4>
                                                    <h4 class="media-heading text-capitalize">Disponível: <b><?= stripslashes($listar->pagina_data)?></b></h4>
                                                </div>
                                            </div>
                                        </div>
