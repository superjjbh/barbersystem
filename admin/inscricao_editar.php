                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info" style="padding-top: 19px;"><p><strong>Editar Inscrição</strong></p></div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="panel-body no-padding">
                                    <form enctype="multipart/form-data" method="post" action="inscricao_fn.php?acao=atualizar">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
												...
												<h4><input type="radio" id="inscricao_observacao" name="inscricao_observacao" value="CONFIRMADO" <?php echo ($inscricao->inscricao_observacao=='CONFIRMADO')?'checked':'' ?> > CONFIRMADO</h4>
												<h4><input type="radio" id="inscricao_observacao" name="inscricao_observacao" value="PENDENTE" <?php echo ($inscricao->inscricao_observacao=='PENDENTE')?'checked':'' ?> > NÃO CONFIRMADO</h4>
												<h4><input type="radio" id="inscricao_observacao" name="inscricao_observacao" value="REALIZADO" <?php echo ($inscricao->inscricao_observacao=='REALIZADO')?'checked':'' ?> > REALIZADO</h4>
											</div>
											

                                            <div class="form-footer">
                                                <div class="pull-right">
												<input type="hidden" id="inscricao_id"  name="inscricao_id" value="<?= $inscricao->inscricao_id ?>">
