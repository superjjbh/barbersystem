        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-mortar-board"></i> <span>Gerenciar Cursos </span></h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title"><a href="curso/novo/"><button class="btn btn-primary" ><i class="fa fa-plus-circle"></i> Novo Curso</button></a></h3>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="datatable-ajax" class="table table-striped table-primary">
                                        ...
                                        <tbody id="galeria">
											<?php if (isset($cursos->db->data[0])): ?>
												<?php foreach ($cursos->db->data as $listar): ?>
                                                    <tr>
                                                        <td style="width: 30%;"><?= stripslashes($listar->curso_nome) ?></td>
														<td style="width: 10%;"><?= stripslashes($listar->curso_data_inicio) ?></td>
														<td><?= stripslashes($listar->curso_profissional) ?></td>
                                                        <td style="width: 20%;">
															<a class="btn btn-circle btn-info atualizar"  href="curso/editar/<?= $listar->curso_id ?>/">
																<i class="fa fa-edit icon-white"></i>
															</a>
                                                            <a class="btn btn-circle btn-danger delete" data-url="curso_fn.php?acao=remover&AMP;id=<?= $listar->curso_id ?>">
                    ...
                    <div class="modal-header ">
                        <form role="form" method="post"  action="profissional_fn.php?acao=atualizar">
                            <div class="form-group">
                                <span class="fa fa-exclamation-triangle pull-right"> Informe o nome do Profissional</span>
                                <label for="profissional_nome">Profissional:</label>
                                <input type="text" class="form-control"  name="profissional_nome" id="profissional_nome" data-toggle="tooltip" data-placement="bottom" title="Informe o Profissional..." value="<?= stripslashes($cursos->profissional_nome) ?>" required />
                                <input type="hidden" id="profissional_id"  name="profissional_id" value="<?= $cursos->profissional_id ?>">
                            </div>
