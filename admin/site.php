        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                <div class="header-content">
                    <h2><i class="fa fa-globe"></i>  <span>Configurações do App</span></h2>
                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info" style="padding-top: 19px;"><p><strong style="padding-top: 19px;">APP - Dados do seu App</strong></p></div>
                                </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-group-divider">
                                                <div class="callout callout-warning">
                                                    <h6 class="no-margin" style="padding-top: 19px;"> O nome do autor do App.</h6>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Autor do App</label>
                                                <input class="form-control rounded" type="text" id="site_meta_autor" readonly name="site_meta_autor" required value="<?= stripslashes($site->site_meta_autor) ?>" >
                                            </div>
                                            <!--<div class="form-group form-group-divider">
                                                <div class="callout callout-warning">
                                                    <h6 class="no-margin" style="padding-top: 19px;"> Informe o horário do início do expediente. Exemplo: 9:00.</h6>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Hora do início do expediente.  </label>
                                            ...
                                            <div class="form-group form-group-divider">
                                                <div class="callout callout-warning">
                                                    <h6 class="no-margin" style="padding-top: 10px;"> Informe o horário do fim do expediente. Exemplo: 18:00.</h6>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Hora do fim do expediente. </label>
