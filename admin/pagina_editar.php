        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-cut"></i>  <span> Serviço</span></h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-sub-heading">
                                    <div class="callout callout-info" style="padding-top: 19px;"><p><strong>Editar Serviço</strong></p></div>
                                ...
                                <div class="panel-body no-padding">
                                    <form  enctype="multipart/form-data" method="post" action="pagina_fn.php?acao=atualizar">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <span class="fa fa-exclamation-triangle pull-right"> Caso deixe vazio o campo 'Valor do Serviço', aparecerá "Consulte-nos" na página de Serviços</span>
                                                <label class="control-label">Valor do Serviço <b>(Sem o R$, apenas o valor. Ex.: 15,00)</b></label>
                                            ...
                                            <div class="form-group">
												...
												<h4><input type="radio" id="pagina_data" name="pagina_data" style="text-transform: uppercase;" value="SIM" <?php echo ($editar->pagina_data=='SIM')?'checked':'' ?> > SIM </h4>
												<h4><input type="radio" id="pagina_data" name="pagina_data" style="text-transform: uppercase;" value="NÃO" <?php echo ($editar->pagina_data=='NÃO')?'checked':'' ?> > NÃO	</h4>											  
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Descrição da Promoção</label>
