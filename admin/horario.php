...
$horario = new Horario();
$horario->db = new DB;
$horario->db->url = "horario";
$horario->db->paginate(24);
$horario->getAreas();
?>
<!DOCTYPE html>
        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-pencil"></i> <span>Gerenciar Horários </span></h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title"><button class="btn btn-primary" data-toggle="modal" data-target="#incluir"><i class="fa fa-plus-circle"></i> Novo Horário</button></h3>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="datatable-ajax" class="table table-striped table-primary">
                                        <thead>
                                            <tr>
                                                <th data-class="expand">Horários</th>
                                        ...
                                        <tbody id="galeria">
                                            <?php if (isset($horario->db->data[0])): ?>
                                                <?php foreach ($horario->db->data as $categoria): ?>
                                                    <tr id="li_<?= $categoria->horario_id ?>">
                                                        <td><?= stripslashes($categoria->horario_nome) ?></td>
                                                        <td style="width: 20%;">
                                                            <a class="btn btn-circle btn-info atualizar" data-update="<?= $categoria->horario_id ?>" >
                                                                <i class="fa fa-edit icon-white"></i>
                                                            </a>
                                                            <a class="btn btn-circle btn-danger delete" data-url="horario_fn.php?acao=remover&AMP;id=<?= $categoria->horario_id ?>">
            ...
            <div class="modal-dialog panel panel-primary">
                <div class="modal-content ">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title text-center">Adicionar novo Horário</h3>
                    </div>
                    <div class="modal-header ">
                        <form role="form" method="post"  action="horario_fn.php?acao=incluir">
                            <div class="form-group">
                                <span class="fa fa-exclamation-triangle pull-right"> Informe o horário nesse formato: HH:MM. Exemplo: 09:30</span>
                                <label for="horario_nome">Horário:</label>
                                <input type="text" class="form-control"  name="horario_nome" data-toggle="tooltip" data-placement="bottom" title="Informe a Categoria..."  required />
                            </div>
        ...
        <div class="modal fade" id="modal-16" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog panel panel-primary">
                <div class="modal-content ">
                    <div class="panel-heading">
                        <button type="button" class="close" data-dismiss="modal">×</button>
                        <h3 class="panel-title text-center">Editar Horário</h3>
                    </div>
                    <div class="modal-header ">
                        <form role="form" method="post"  action="horario_fn.php?acao=atualizar">
                            <div class="form-group">
                                <span class="fa fa-exclamation-triangle pull-right"> Informe o horário nesse formato: HH:MM. Exemplo: 09:30</span>
                                <label for="horario_nome">Horário:</label>
                                <input type="text" class="form-control"  name="horario_nome" id="horario_nome" data-toggle="tooltip" data-placement="bottom" title="Informe a Categoria..." value="<?= stripslashes($horario->horario_nome) ?>" required />
                                <input type="hidden" id="horario_id"  name="horario_id" value="<?= $horario->horario_id ?>">
                            </div>
...
<?php endif; ?>
            ...
            $('.atualizar').on('click', function () {
                ...
                $('#horario_id').val(id);
                var url = "horario_fn.php?acao=Json";
                $.getJSON(url, {horario_id: id}, function (data) {
                    //console.log(data);
                    $('#modal-16  #horario_id').val(data.horario_id);
                    $('#modal-16  #horario_nome').val(data.horario_nome);
                });
                $('#modal-16').modal('show');
            });
            ...
            function reloadActions() {
                ...
                $("#galeria").sortable({opacity: 0.6, cursor: "move",
                    stop: function (event, ui) {
                        ...
                        var url = 'horario_fn.php?acao=posicao';
