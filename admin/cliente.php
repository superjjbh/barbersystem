        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-tags"></i> <span>Promoções Cadastradas</span></h2>
                ...
                <!--/ End page header -->
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-left">
								<a href="promocao/novo/"><button type="button" class="btn btn-success"><i class="fa fa-plus-circle"></i> Nova Promoção</button></a>
                            </div>
                                    ...
                                    <div class="gallery-item rounded shadow">
                                        ...
                                        <div class="gallery-author">
                                            <div class="media">
                                                <div class="media-body text-center">
													...
													<h4>R$ <?= stripslashes($listar->cliente_descricao) ?></h4>
													</br>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="gallery-details">
                                            <div class="text-center">
                                                <a class="btn btn-circle btn-info atualizar"  href="promocao/editar/<?= $listar->cliente_id ?>/">
