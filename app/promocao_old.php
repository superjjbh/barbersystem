...
$adicional = new Pagina();
$pagina_id = intval($_GET['id']);
$adicional->pagina_id = "$pagina_id";
$adicional->getAdicionais($pagina_id);
...
<div data-role="page" id="about" class="secondarypage" data-theme="b">
    ...
    <div role="main" class="ui-content">
       ...
       <div class="pages_maincontent">
              <h2 class="page_title"><?= stripslashes($pagina->cliente_nome) ?> - R$ <?= stripslashes($pagina->cliente_descricao) ?></h2> 
              <div class="page_content"> 
				...
				<img src="../images/team/<?= $pagina->cliente_imagem ?>" alt="" class="img-responsive" /> 
					...
					<h2 class="page_title">Descrição da Promoção:</h2>
					...
					<p>Envie seus dados, data e horário para verificarmos a disponibilidade, para melhor atendê-lo!</p>
									...
									<form method="post" action="confirmaragenda.php" id="contactfrm" role="form" name="form" onSubmit="return enviardados();">
											...
											<hr>
												...
												<p align="center"><font style='color:#009900;font-weight:bold;'>Adicione até 4 serviços adicionais, além da promoção selecionada:</font></p><h3 align="center"><font style='color:blue;font-weight:bold;'><?= stripslashes($pagina->cliente_nome) ?> R$ <?= stripslashes($pagina->cliente_descricao) ?>
												</h3></font>
									...
									<div data-role="tabs" id="tabs">
									  ...
									  <br>
												...
												<label>Resumo dos valores:</label>
													Valor da Promoção solicitada: <?= stripslashes($pagina->cliente_nome) ?>
													<input readonly type="text" style="text-align: center;" name="servico_valor" id="servico_valor" value="<?= stripslashes($pagina->cliente_descricao) ?>" />
													...
													<b>Total:<input readonly type="text" id="servico_valor_total" name="servico_valor_total" style="text-align: center;" value="<?= stripslashes($pagina->cliente_descricao) ?>" onblur="calcular()" ></b>
											...
											<input type="hidden" name="servico_descricao" style="text-transform:uppercase" value="<?= stripslashes($pagina->cliente_nome) ?>">
											<input type="hidden" name="servico_status" value="0">
											<input type="hidden" name="servico_pagina" style="text-transform:uppercase" value="<?= stripslashes($pagina->cliente_id) ?>">
