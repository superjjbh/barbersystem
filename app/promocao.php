              ...
              <div class="page_content"> 
				...
				<img src="../images/team/<?= $pagina->cliente_imagem ?>" alt="" class="img-responsive" /> 
					...
					<h2 class="page_title">Agendamento On line</h2>
									...
									<form method="post" action="agendar.php" id="contactfrm" role="form" name="form" onSubmit="return enviardados();">
                                           
                                            <div class="result"></div>
											<input type="hidden" name="servico_descricao" style="text-transform:uppercase" value="<?= stripslashes($pagina->cliente_nome) ?>">
											<input type="hidden" name="servico_valor" style="text-transform:uppercase" value="<?= stripslashes($pagina->cliente_descricao) ?>">
