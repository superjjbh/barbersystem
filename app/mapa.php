...
<div data-role="page" id="about" class="secondarypage" data-theme="b">
    ...
    <div role="main" class="ui-content">
       ...
       <div class="pages_maincontent">
              <h2 class="page_title">localização</h2> 
              <div class="page_content"> 
              
			<iframe src="http://www.ecstartup.com.br/teste/srblackbarbearia/mapa.php" width="100%" height="1000px" frameborder="0" style="border:0"></iframe>
              </div>
       </div>
