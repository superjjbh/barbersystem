...
<div data-role="page" id="photos" class="secondarypage" data-theme="b">
    ...
    <div role="main" class="ui-content">
       <div class="pages_maincontent">
              <h2 class="page_title">galeria de fotos</h2> 
              <div class="page_content"> 
    
             <ul id="photoslist" class="photo_gallery_13">
        <?php if (isset($projeto->db->data[0])): ?>
            <?php foreach ($projeto->db->data as $trabalhos): ?>
                <h3 align="center"><?= stripslashes($trabalhos->area1_nome) ?> | <?= stripslashes($trabalhos->portfolio_nome) ?></h3>
				<div align="center"><a rel="gallery-1" href="../images/portfolio/<?= $trabalhos->portfolio_imagem ?>" title="<?= stripslashes($trabalhos->area1_nome) ?> | <?= stripslashes($trabalhos->portfolio_nome) ?>" class="swipebox"><img align="center" src="../images/portfolio/<?= $trabalhos->portfolio_imagem ?>" width="70%" alt="image"/></a></div>
               <hr>
			   <div class="clear"></div>
              </ul> 
            <?php endforeach; ?>
