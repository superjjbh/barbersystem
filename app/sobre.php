...
<div data-role="page" id="about" class="secondarypage" data-theme="b">
    ...
    <div role="main" class="ui-content">
       ...
       <div class="pages_maincontent">
              <h2 class="page_title"><?= stripslashes($sobre->modulo3_nome) ?></h2> 
              <div class="page_content"> 
				<div align="center" class="imgBorder" style="min-height: 100px; margin-top:5px">
				<img src="../images/<?= $sobre->modulo3_imagem ?>" alt="" class="img-responsive" /> </div>              
				<h3><?= stripslashes($sobre->modulo3_descricao)?></h3>
				<hr>
				<div align="center">
				<h4>Expediente: <?= $site->site_analytics ?></h4>
				<a href="contato.php"><button type="button" class="btn btn-primary btn-lg">Fale Conosco</button></a>
				</div>
              </div>
