...
<div data-role="page" id="features" class="secondarypage" data-theme="b">
    ...
    <div role="main" class="ui-content">
       <div class="pages_maincontent">
              <h2 class="page_title">CONTEÚDO DO NOSSO APLICATIVO EM SEU IPHONE OU IPAD</h2> 
              <div class="page_content"> 
    
				<h3>Instruções para que possa ter acesso ao nosso aplicativo</h3>
				<h3>Passo 1</h3>
				<h4 align="center"><span>Pelo navegador Safari em seu iPhone ou iPad, acesse nossa tela principal: </br></br> 
				<h4 align="center"><font style="color:#009900;font-weight:bold;">www.<?= $site->site_sobre_titulo ?></font></h4> </br>
				e depois toque sobre o botão de compartilhamento – 
				'ícone com um retângulo e uma seta apontando para cima'. No menu de compartilhamento, toque em “Tela de Início”.</span></br></h4>
				<div align="center">
				<img align="center" src="./images/passo1.jpg" alt="" class="img-responsive" />
				<img align="center" src="./images/passo3.jpg" alt="" class="img-responsive" />
				</div>
				<h3>Passo 2</h3>
				<h4 align="center"><span>Caso queira, você pode alterar o nome do site ou abreviá-lo. Feito isso, toque em “Adicionar”, no canto superior direito da tela. O atalho para o app será adicionado ao fim da tela inicial do seu iPhone, 
				como se fosse um aplicativo tradicional. Caso queira, você pode arrastá-lo para outro local ou fixar na dock.</span></h4>
				<div align="center"><img align="center" src="./images/passo3.jpg" alt="" class="img-responsive" /><br></div>
