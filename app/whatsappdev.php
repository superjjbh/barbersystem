...
<div data-role="page" id="about" class="secondarypage" data-theme="b">
    ...
    <div role="main" class="ui-content">
       ...
       <div class="pages_maincontent">
              <h2 class="page_title">whatsapp</h2> 
              <div class="page_content"> 
              
                           
			<h3 align="center">Clique no botão abaixo, para iniciar uma conversa no WhatsApp com o desenvolvedor do aplicativo <?= $site->site_meta_titulo ?></h3>
           <p align="center">

		    <a href="https://api.whatsapp.com/send?phone=5531986407398&text=Ola, Estou entrando em contato através do app <?= $site->site_meta_titulo ?>." target="_blank">
                <button class="btn btn-success" align="center"><i class="fa fa-whatsapp"></i> Iniciar conversa!</button>
            </a></p>
