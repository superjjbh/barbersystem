       ...
       <div class="pages_maincontent">
			<div class="page_content">
			  ...
			  <div><h3>Confira os dados do seu agendamento:</h3></div>
				...
				<b>Serviço ou Promoção Solicitado(a):</b> <?= stripslashes($_POST['servico_descricao']) ?> - R$ <?= stripslashes($_POST['servico_valor']) ?></br> 
				<b>Serviços Adicionais:</b> <?= stripslashes($_POST['servico_adicional']) ?> | <?= stripslashes($_POST['servico_adicional2']) ?> | <?= stripslashes($_POST['servico_adicional3']) ?> | <?= stripslashes($_POST['servico_adicional4']) ?> </br>								
				<b>Valor dos Serviços Adicionais:</b> R$ <?= stripslashes($_POST['servico_valor_adicional']) ?></br>	
				<b>Valor Total do Serviço:</b> R$ <?= stripslashes($_POST['servico_valor_total']) ?></br>
				<b>Forma de Pagamento:</b> <?= stripslashes($_POST['servico_pagamento']) ?></br>
				<b>Data Escolhida:</b> <?= date("d/m/Y", strtotime($_POST['servico_data'])) ?></br>				
				<b>Horário Escolhido:</b> <?= stripslashes($_POST['servico_horario']) ?></br>
				<b>Profissional Designado: </b><?= stripslashes($_POST['servico_profissional']) ?></br>
				</div>
              ...
              <div class="page_content"> 
							    <?php
                                    if (isset($_POST['servico_email']) && !empty($_POST['servico_email'])) {
									  ...
									  header("Content-Type: text/html; charset=UTF-8");
										...
										$servico->servico_valor = $servico_valor;
										$servico->servico_valor_adicional = $servico_valor_adicional;
										$servico->servico_valor_total = $servico_valor_total;
										...
										$servico->servico_pagamento = $servico_pagamento;
										$servico->gravar();
										...
										$body .= "<b>Serviço ou Promoção: </b>$servico_descricao - R$ $servico_valor<br />";
				...
				<?php if (isset($_POST['servico_email']) && !empty($_POST['servico_email'])) : ?>					
				<div align="center">
				<a href="https://api.whatsapp.com/send?phone=55<?= stripslashes($site->site_meta_autor) ?>&text=Ola, me chamo <?= stripslashes($_POST['servico_nome']) ?>, tudo bem? Acabei de enviar um agendamento e gostaria de verificar a disponibilidade conforme enviado: Meu Nome: <?= stripslashes($_POST['servico_nome']) ?> | Meu Celular: <?= stripslashes($_POST['servico_icon']) ?> | Unidade: <?= stripslashes($_POST['servico_unidade']) ?> | Serviço/Promoção: <?= stripslashes($_POST['servico_descricao']) ?> - <?= stripslashes($_POST['servico_adicional']) ?> - <?= stripslashes($_POST['servico_adicional2']) ?> - <?= stripslashes($_POST['servico_adicional3']) ?> - <?= stripslashes($_POST['servico_adicional4']) ?> | Valor total: R$ <?= stripslashes($_POST['servico_valor_total']) ?> | Forma de Pagamento: <?= stripslashes($_POST['servico_pagamento']) ?> | Data: <?= date("d-m-Y", strtotime($_POST['servico_data'])) ?> | Horário: <?= stripslashes($_POST['servico_horario']) ?> | Observação: <?= stripslashes($_POST['mensagem']) ?>. Teria disponibilidade?" target="_blank"><img src="images/whatsapp.png" alt="" title="" /></a>
				<?php endif; ?>
				</div>
				<div align="center">
