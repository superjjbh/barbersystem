...
<div data-role="page" id="features" class="secondarypage" data-theme="b">
    ...
    <div role="main" class="ui-content">
       <div class="pages_maincontent">
              <h2 class="page_title">nossas promoções</h2> 
              <div class="page_content"> 
                    ...
                    ?>
                    <?php 
                    $padrinho = new Cliente();
                    $padrinho->getClientes();
                    ?>                
	  ...
	  <ul class="features_list_detailed">
          ...
          <li>
          <div class="feat_small_icon"><img src="../images/team/<?= $e->cliente_imagem ?>" alt="" title="" /></div>		 
          <div class="feat_small_details"> 
          <h4><a href="promocao.php?id=<?= $e->cliente_id ?>" data-transition="slidefade"><?= stripslashes($e->cliente_nome) ?></a></h4>
          <p><?= stripslashes($e->cliente_subtitulo) ?> - R$ <?= stripslashes($e->cliente_descricao) ?></p>
          </div>
          <div class="view_more"><a href="promocao.php?id=<?= $e->cliente_id ?>" data-transition="slidefade"><img src="images/mais.png" alt="" title="" /></a></div>
          </li> 
                                        <?php endforeach; ?>
                                    <?php endif; ?>
