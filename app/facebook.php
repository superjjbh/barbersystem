...
<div data-role="page" id="about" class="secondarypage" data-theme="b">
    ...
    <div role="main" class="ui-content">
       ...
       <div class="pages_maincontent">
              <h2 class="page_title">Facebook</h2> 
              <div class="page_content"> 
				...
				<script>(function(d, s, id) {
				  ...
				  js.src = 'https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v3.2&appId=1984203228280112&autoLogAppEvents=1';
				  fjs.parentNode.insertBefore(js, fjs);
				}(document, 'script', 'facebook-jssdk'));</script>
				</div>              
				<hr>
				<div align="center">
				<div class="fb-page" data-href="https://www.facebook.com/jemtecnologia" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false">
				<blockquote cite="https://www.facebook.com/jemtecnologia" class="fb-xfbml-parse-ignore">
				<a href="https://www.facebook.com/jemtecnologia">J&amp;M Tecnologia</a></blockquote></div>
				</div>
              </div>
