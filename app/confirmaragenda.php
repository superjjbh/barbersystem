    ...
    <div role="main" class="ui-content">
       ...
       <div class="pages_maincontent">
			<div class="page_content">
			  ...
			  <div><h3>OBRIGADO, <?= stripslashes($_POST['servico_nome']) ?>!!</h3></div>
				</div>
			  <div align="center"><h3>Seu agendamento foi realizado com sucesso! Clique no botão abaixo para confirmar seu agendamento pelo WhatsApp!</h3></div>
			  <?php endif; ?>
              <div class="page_content"> 
							    <?php
                                    if (isset($_POST['servico_email']) && !empty($_POST['servico_email'])) {
									  ...
									  header("Content-Type: text/html; charset=UTF-8");
										...
										$servico_valor = addslashes(number_format($_POST['servico_valor'], 2, ',', ''));
										$servico_valor_adicional = addslashes($_POST['servico_valor_adicional']);
										$servico_valor_total = addslashes(number_format($_POST['servico_valor_total'], 2, ',', ''));
