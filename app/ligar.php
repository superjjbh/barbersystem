...
<div data-role="page" id="about" class="secondarypage" data-theme="b">
    ...
    <div data-role="header" data-position="fixed">
        ...
        <div class="nav_center_logo">Barber System</div>
    ...
    <div role="main" class="ui-content">
       ...
       <div class="pages_maincontent">
              <h2 class="page_title">ligar</h2> 
              <div class="page_content"> 
              
                           
			<h3 align="center">Clique no botão abaixo, para ligar para <?= $site->site_meta_titulo ?></h3>
           <p align="center">

		    <a href="tel:<?= $site->site_meta_desc ?>" target="_blank">
                <button class="btn btn-primary" align="center"><i class="fa fa-phone"></i> Ligar Agora!</button>
            </a></p>
